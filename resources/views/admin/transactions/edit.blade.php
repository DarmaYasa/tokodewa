                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="custom-select select2 @error('type') is-invalid @enderror">
                                    ...
                                    <option value="Lorem" @if(old('type', $service->type) == 'Lorem') selected @endif>Lorem</option>
                                    <option value="Ipsum" @if(old('type', $service->type) == 'Ipsum') selected @endif>Ipsum</option>
                                    <option value="Dolor" @if(old('type', $service->type) == 'Dolor') selected @endif>Dolor</option>
                                </select>
                                @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
