...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker dropdown-menu"><div class="drp-header"><span class="drp-header-text">Date</span> <span class="drp-header-close"></span></div>' +
        ...
        this.container.find('.ranges')
            ...
            .on('click.daterangepicker', 'span.drp-header-close', $.proxy(this.clickCancel, this))
            .on('click.daterangepicker', 'li', $.proxy(this.clickRange, this))
            .on('mouseenter.daterangepicker', 'li', $.proxy(this.hoverRange, this))
            .on('mouseleave.daterangepicker', 'li', $.proxy(this.updateFormInputs, this));

        this.container.find('.drp-header')
            .on('click.daterangepicker', 'span.drp-header-close', $.proxy(this.clickCancel, this))
